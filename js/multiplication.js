...
function begin001() {
    ...
    submitBtn = sum.innerHTML = rsn1 + " &times; " + rsn2 + ' = <input type="number" id=input001 /> <button onclick=submit001() id="submit">Submit</button>';
...
function submit001() {
    ...
    nextBtn = sum.innerHTML = rsn1 + " &times; " + rsn2 + ' = ' + userResponse + "<button id='next' onclick=question002()>Next</button>";
